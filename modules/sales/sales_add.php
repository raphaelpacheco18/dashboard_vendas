...
// Substitua a parte de processamento do formulário por:
        ...
        try {
            ...
            if ($tipo_pagamento_form === 'Múltiplo') {
                ...
                if (abs($calculated_total - $valor_total) > 0.01) {
                    throw new Exception('A soma dos pagamentos não corresponde ao valor total');
                }
            ...
            $stmt = $pdo->prepare("INSERT INTO vendas 
                                 (produto_id, loja_id, vendedora_id, valor_total, tipo_pagamento, varios_pagamentos, data_venda) 
                                 VALUES (?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([$produto_id, $loja_id, $vendedora_id, $valor_total, $tipo_pagamento, $varios_pagamentos, $data_venda]);
            ...
            $_SESSION['error'] = 'Erro ao cadastrar venda: ' . $e->getMessage();
        }
    }
...
<head>
    ...
    <title>Nova Venda - Dashboard</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-12">
                <h2><i class="bi bi-plus-lg"></i> Nova Venda</h2>
                <hr>
                ...
                <form method="post" action="sales_add.php">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="vendedora_id" class="form-select select2" required>
                                ...
                                <?php foreach ($vendedoras as $vendedora): ?>
                                    <option value="<?= $vendedora['id'] ?>"><?= htmlspecialchars($vendedora['nome']) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="valor_total" class="form-control" step="0.01" min="0" required>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="tipo_pagamento" id="tipoPagamento" class="form-select" required>
                                ...
                                <option value="Múltiplo">Múltiplas Formas</option>
                            </select>
                        </div>
                        ...
                        <div class="col-12" id="multiPaymentFields" style="display: none;">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <strong>Total Parciais: R$ <span id="multiPaymentTotal">0,00</span></strong>
